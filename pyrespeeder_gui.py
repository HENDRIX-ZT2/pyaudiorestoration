...
class MainWindow(widgets.MainWindow):
	...
	def __init__(self):
		...
		button_data = ( (fileMenu, "Open", self.canvas.open_audio, "CTRL+O"), \
						...
						(editMenu, "Undo", self.canvas.restore_traces, "CTRL+Z"), \
						# (editMenu, "Redo", self.props.foo, "CTRL+Y"), \
						(editMenu, "Select All", self.canvas.select_all, "CTRL+A"), \
						(editMenu, "Invert Selection", self.canvas.invert_selection, "CTRL+I"), \
						(editMenu, "Merge Selected", self.canvas.merge_selected_traces, "CTRL+M"), \
						(editMenu, "Delete Selected", self.canvas.delete_traces, "DEL"), \
						# (editMenu, "Play/Pause", self.canvas.audio_widget.play_pause, "SPACE"), \
						)
